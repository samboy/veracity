...
#ifndef VV_RENAME_DIALOG_H
#define VV_RENAME_DIALOG_H
 ...
 * a wxTextEntryDialog.
 */
class vvRenameDialog : public vvDialog
{
// functionality
public:
	/**
	...
	virtual bool Create(
		...
		const wxString&      sInitialValue,                   //< [in] The directory where a working copy is being created.
...
private:
	// internal data
	wxString     msNewName;        //< The new name 
	wxTextCtrl * mwTextEntry; 
	
// macro declarations
private:
	DECLARE_DYNAMIC_CLASS(vvRenameDialog);
	DECLARE_EVENT_TABLE();
};
