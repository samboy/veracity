...
function st_named_branches_03()
{
    this.no_setup = true;

    this.test_3 = function test_3() 
    {
        var r1_name = sg.gid();
	...
	sg.vv2.whoami({ "username" : "e", "create" : true });
		...
		if (o.exit_status != 0)
		{
			print("exit status is: " + o.exit_status);
			print(o.stderr);
		}
        ...
        // -------- go to r4 and try a plain merge
        sg.fs.cd(r4_path);
        ...
        // -------- go to r4 and merge r2
        sg.fs.cd(r4_path);

        o = sg.exec(vv, "merge", "-r", r2_leaf);
        print(sg.to_json(o));
        testlib.ok(o.exit_status == 0);
        ...
        // -------- make sure the branch still needs merge
        o = sg.exec(vv, "branch", "list");
        print(sg.to_json(o));
        testlib.ok(o.exit_status == 0);
        testlib.ok(o.stdout.search("needs merge") > 0);
        ...
        // -------- now merge r3 (with a plain merge)
        sg.fs.cd(r4_path);
        ...
        // -------- make sure the branch no longer needs merge
        o = sg.exec(vv, "branch", "list");
        print(sg.to_json(o));
        testlib.ok(o.exit_status == 0);
        testlib.ok(o.stdout.search("needs merge") < 0);
