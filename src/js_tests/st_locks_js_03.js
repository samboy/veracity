...
function st_locks_01()
{
	...
	//////////////////////////////////////////////////////////////////
	vscript_test_wc__print_section_divider("in r2, lock the file as john");
	...
	//////////////////////////////////////////////////////////////////
	vscript_test_wc__print_section_divider("in r3, modify the file as paul");

        sg.fs.cd(r3_path);

	sg.vv2.whoami({ "username" : "paul" });

        sg.file.append("f1.txt", "paul was here\n");
	...
	//////////////////////////////////////////////////////////////////
	vscript_test_wc__print_section_divider("in r4, check the locks as paul");
